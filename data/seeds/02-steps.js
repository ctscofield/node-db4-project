...
exports.seed = function(knex, Promise) {
  return knex('steps').insert([
    ...
    {step_number: '3', instructions: "Boil noodles for 3 minutes or until soft stirring occasionally", quantity_id: "", ingredient_id: ""},
    {step_number: '4', instructions: "Once noodles are done pour water and noodles into bowl", quantity_id: "", ingredient_id: ""},
